...
namespace SecureMessengerDNet
{
    ...
    public class Contact
    {
        ...
        public ObservableCollection<Message> Messages(Contact person)
        {
            IEnumerable<Message> authorQuery =
                   from message in Singleton.Instance.Messages
        ...
        public Contact(String nickname, Nullable<DateTime> lastSeen)
        {
            _id = System.Guid.NewGuid().ToString();
            _nickname = nickname;
            _lastSeen = lastSeen;
